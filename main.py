...
def initialize_services():
    ...
    # Using 'accelerate' and 'torch' for better performance
    llm_pipeline = Ollama()
...
def get_llm_response(llm_pipeline, prompt):
    ...
    # The response is often inside a nested dictionary
    if sequences and isinstance(sequences[0], dict) and 'generated_text' in sequences[0]:
        # We only want the part generated by the assistant
